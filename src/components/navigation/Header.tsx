...
export function Header() {
  ...
  return (
    <header>
      <div className="sticky top-0 z-sticky h-14 border-b-2 border-brand bg-blacktop md:hidden">
        <Container className="flex h-full items-center justify-between">
          ...
          <Link href="/" aria-label="Everything Sports home">
            <ESCutMark tone="reversed" size={26} />
          </Link>
          <IconButton
            tone="reversed"
            label="Open search"
      ...
      <div className="hidden md:block">
        <div className="bg-blacktop text-clean-sheet">
          <Container className="flex h-24 items-center justify-between">
            <div className="flex items-center gap-6">
              <Link href="/" aria-label="Everything Sports home">
                <Wordmark tone="reversed" className="text-4xl lg:text-5xl" />
              </Link>
              <span className="hidden text-meta font-semibold text-clean-sheet/65 lg:inline">
                Independent sports desk, live all day
              </span>
            </div>
            <IconButton
              tone="reversed"
        ...
        <div className="sticky top-0 z-sticky border-b border-border bg-canvas">
          <Container className="flex h-14 items-center gap-6">
            <Link
              href="/"
              aria-label="Everything Sports home"
              className="mr-2 shrink-0"
            >
              <ESCutMark tone="brand" size={21} />
            </Link>
